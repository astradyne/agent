...
if($_POST)
{
    ...
    //? represents i will provide later
    $stmt->execute([$_POST['username'] ]);//replaces ? as username
    $result = $stmt->fetch();
...
<div class="col-12 bg-white px-5 py-3 m-3 mt-5 border-dark ">
    <h1 class="text-left">Sign In</h2><br>

  <form action="login.php" method="post">
    <div class="form-group row">
        
        <div class="col-sm-10">
            <input type="name" name="username" class="form-control border border-danger" id="name" placeholder="Username"><br>
        </div>
        </div>
        <div class="form-group row">
    ...
    <div class="form-group row">
      <div class="col-sm-10">
        <button type="submit" class="d-inline btn btn-outline-danger btn-block">Sign in</button>
        
        <a href="register.php"><button type="submit" class="d-inline btn btn-outline-danger btn-block">Sign up</button></a>
      </div>
    </div>
  </form>
